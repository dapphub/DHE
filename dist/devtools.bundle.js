...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash = __webpack_require__(714);

	var _lodash2 = _interopRequireDefault(_lodash);

	var _devtools = __webpack_require__(718);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	try {
	  (0, _devtools.webpackMain)(chrome, console, Math);
	} catch (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dheBridge = __webpack_require__(719);
	...
	var setupPanel = _.curry(function (chrome, console, Math, panel) {
	  panel.onShown.addListener(function tmp(panelWindow) {
	    ...
	    var onout = port.postMessage.bind(port);
	    var dappMsg$ = _xstream2.default.create({
	    ...
	    _window.run(_window.main, {
	      ...
	      Sniffer: (0, _dheBridge2.default)({
	        onout: onout, // forward some msgs to dapp
	        in$: _xstream2.default.merge(dappMsg$) // msgs received from dapp
	      }),
	...
	function webpackMain(chrome, console, Math) {
	  chrome.devtools.panels.create("DappHub", "chrome.png", "panel.html", setupPanel(chrome, console, Math));
	}

	module.exports = {
	  setupPanel: setupPanel,
	  webpackMain: webpackMain
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function DHEBridge(_ref) {
	  var onout = _ref.onout,
	      in$ = _ref.in$;
	  var console = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : console;
	  ...
	  return function dheBridgeDriver(out$) {
	    ...
	    return _xstream2.default.merge(in$ || _xstream2.default.of());
	  };
	}
